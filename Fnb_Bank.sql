...
CREATE TABLE [Fnb_Bank].[dbo].[People] (
...
INSERT INTO [Fnb_Bank].[dbo].[People]
(person_id, first_name, last_name, email, phone, city, date_of_birth) VALUES
...
--
-- ============================
CREATE TABLE [Fnb_Bank].[dbo].[transactions] (
...
INSERT INTO [Fnb_Bank].[dbo].[transactions]
(transaction_id, person_id, transaction_date, description, amount, transaction_type) 
VALUES
...
B.description,
B.amount
From [Fnb_Bank].[dbo].[People] As A
Inner Join [Fnb_Bank].[dbo].[transactions] As B
